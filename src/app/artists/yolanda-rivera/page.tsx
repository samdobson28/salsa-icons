    ...
    <div>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          pride. Notably, her cover of Rocío Jurado's "Ese Hombre" became a
          salsa anthem, ranking first on Billboard's Tropical Airplay for five
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <a
              href="https://scholarshare.temple.edu/bitstream/handle/20.500.12613/1255/Gainer_temple_0225M_12616.pdf?sequence=1&isAllowed=y"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline"
            >
